...
var famous_person : string =  "Dwayne Johnson";
var message : string = `${famous_person} once said, "Success isn't always about greatness. It's about consistency. Consistent hard work leads to success. Greatness will come."`;
console.log(message);
console.log("\n");
